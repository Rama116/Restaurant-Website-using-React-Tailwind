  ...
  return (
    <>
         <div className="h-screen w-screen bg-slate-50 flex flex-row justify-center items-center">
            <form className="h-[29rem] w-[25rem] md:w-[26rem] border-2 border-orange-700 rounded-2xl bg-white box-shadow: 0 25px 50px -12px rgb(0 0 0 / 0.25); flex flex-col gap-6 justify-center items-center">
